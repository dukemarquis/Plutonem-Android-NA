...
import com.plutonem.ui.nemur.adapters.NemurSearchSuggestionRecyclerAdapter.SearchSuggestionHolder;

import org.jetbrains.annotations.NotNull;
import org.wordpress.android.util.SqlUtils;

public class NemurSearchSuggestionRecyclerAdapter extends RecyclerView.Adapter<SearchSuggestionHolder> {
    ...
    public NemurSearchSuggestionRecyclerAdapter() {
    ...
    public SearchSuggestionHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        final View view =
                LayoutInflater.from(context).inflate(R.layout.nemur_listitem_suggestion_recycler, parent, false);
    ...
    private void onBindSuggestionViewHolder(final SearchSuggestionHolder holder) {
        final String query = mCursor.getString(mCursor.getColumnIndex(NemurSearchTable.COL_QUERY));
    ...
    public long getItemId(int position) {
        ...
        return mCursor.getLong(mCursor.getColumnIndex(NemurSearchTable.COL_ID));
    }
    ...
    private void setQuery(final String newQuery, final boolean forceUpdate) {
        ...
        swapCursor(NemurSearchTable.getQueryStringCursor(newQuery, maxSuggestions));
    }
