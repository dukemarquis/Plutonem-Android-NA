...
class BasicFragmentDialog : AppCompatDialogFragment() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (savedInstanceState != null) {
            mTag = savedInstanceState.getString(STATE_KEY_TAG).toString()
            mTitle = savedInstanceState.getString(STATE_KEY_TITLE)
            mMessage = savedInstanceState.getString(STATE_KEY_MESSAGE).toString()
            mPositiveButtonLabel = savedInstanceState.getString(STATE_KEY_POSITIVE_BUTTON_LABEL).toString()
