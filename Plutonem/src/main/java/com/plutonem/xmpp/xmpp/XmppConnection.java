...
import com.plutonem.xmpp.crypto.DomainHostnameVerifier;
import com.plutonem.xmpp.crypto.XmppDomainVerifier;
import com.plutonem.xmpp.crypto.sasl.Anonymous;
import com.plutonem.xmpp.crypto.sasl.DigestMd5;
import com.plutonem.xmpp.crypto.sasl.External;
import com.plutonem.xmpp.crypto.sasl.Plain;
import com.plutonem.xmpp.crypto.sasl.SaslMechanism;
import com.plutonem.xmpp.crypto.sasl.ScramSha1;
import com.plutonem.xmpp.crypto.sasl.ScramSha256;
...
import com.plutonem.xmpp.services.NotificationService;
...
import com.plutonem.xmpp.utils.SSLSocketHelper;
import com.plutonem.xmpp.utils.SocksSocketFactory;
import com.plutonem.xmpp.utils.XmlHelper;
import com.plutonem.xmpp.xml.Element;
import com.plutonem.xmpp.xml.LocalizedContent;
import com.plutonem.xmpp.xml.Namespace;
import com.plutonem.xmpp.xml.Tag;
import com.plutonem.xmpp.xml.TagWriter;
import com.plutonem.xmpp.xml.XmlReader;
import com.plutonem.xmpp.xmpp.jingle.OnJinglePacketReceived;
import com.plutonem.xmpp.xmpp.stanzas.AbstractAcknowledgeableStanza;
...
import com.plutonem.xmpp.xmpp.stanzas.csi.ActivePacket;
import com.plutonem.xmpp.xmpp.stanzas.csi.InactivePacket;
import com.plutonem.xmpp.xmpp.stanzas.streammgmt.AckPacket;
import com.plutonem.xmpp.xmpp.stanzas.streammgmt.EnablePacket;
import com.plutonem.xmpp.xmpp.stanzas.streammgmt.RequestPacket;
import com.plutonem.xmpp.xmpp.stanzas.streammgmt.ResumePacket;
...
public class XmppConnection implements Runnable {
    ...
    private void register() {
        // for now we skip PRE_AUTH_REGISTRATION_TOKEN check condition and go straight to normal registry
        sendRegistryRequest();
    }
    ...
    private void sendRegistryRequest() {
        ...
        sendUnmodifiedIqPacket(register, (account, packet) -> {
            ...
            if (query.hasChild("username") && (query.hasChild("password"))) {
                ...
                // if there is any other situation, add it here
            }
    ...
    private List<Map.Entry<Jid, ServiceDiscoveryResult>> findDiscoItemsByFeature(final String feature) {
        synchronized (this.disco) {
    ...
    public Jid findDiscoItemByFeature(final String feature) {
        final List<Map.Entry<Jid, ServiceDiscoveryResult>> items = findDiscoItemsByFeature(feature);
        if (items.size() >= 1) {
    ...
    public void resetAttemptCount(boolean resetConnectionTime) {
        this.attempt = 0;
        ...
        public boolean httpUpload(long filesize) {
            if (Config.DISABLE_HTTP_UPLOAD) {
                ...
                for (String namespace : new String[]{Namespace.HTTP_UPLOAD, Namespace.HTTP_UPLOAD_LEGACY}) {
                    List<Map.Entry<Jid, ServiceDiscoveryResult>> items = findDiscoItemsByFeature(namespace);
                    if (items.size() > 0) {
                        try {
