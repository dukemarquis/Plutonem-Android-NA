...
/**
 * search suggestion table - populated by user's nemur search history
 */
public class NemurSearchTable {
    ...
    public static void addOrUpdateQueryString(@NonNull String query) {
        ...
        SQLiteStatement stmt = NemurDatabase.getWritableDb().compileStatement(
    ...
    public static void deleteQueryString(@NonNull String query) {
        ...
        NemurDatabase.getWritableDb().delete("tbl_search_suggestions", "query_string=?", args);
    }

    public static void deleteAllQueries() {
        SqlUtils.deleteAllRowsInTable(NemurDatabase.getWritableDb(), "tbl_search_suggestions");
    }
    ...
    public static Cursor getQueryStringCursor(String filter, int max) {
        ...
        return NemurDatabase.getReadableDb().rawQuery(sql, args);
    }
}
